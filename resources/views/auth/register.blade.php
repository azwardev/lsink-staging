  ...
  <div class="authentication-inner row">
    ...
    <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
      <div class="w-px-400 mx-auto">
        ...
        <!-- /Logo -->
        <h3 class="mb-1">Hanya beberapa klik untuk log masuk ke dalam akaun.</h3>
        <p class="mb-4">Urus lesen- lesen anda dengan lebih efisen di sini.</p>
        ...
        <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
          ...
          <!-- /reCAPTCHA -->
          <button type="submit" class="btn btn-primary d-grid w-100">Daftar Akaun</button>
        </form>

        <p class="text-center mt-2">
          <span>Anda telah mempunyai akaun?</span>
          @if (Route::has('login'))
          <a href="{{ route('login') }}">
            <span>Log Masuk</span>
          </a>
